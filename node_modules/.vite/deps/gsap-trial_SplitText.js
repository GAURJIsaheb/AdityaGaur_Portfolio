//#region node_modules/gsap-trial/SplitText.js
/*!
* SplitText 3.12.7
* https://gsap.com
* 
...
var u, e, t, F, C, i, n = /(?:\r|\n|\t\t)/g, s = /(?:\s\s+)/g, E = String.fromCharCode(160), l = (D) => {
	...
	var u = "undefined" != typeof window, e = 0 === (u ? window.location.href : "").indexOf(o(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(o(108, 111, 99, 97, 108, 104, 111, 115, 116)) || a.test(D) || (u ? window.location.hostname : "").split(".").pop() === o(108, 111, 99, 97, 108), t = [
		...
		if (u) if ("loading" === document.readyState || "interactive" === document.readyState) document.addEventListener("readystatechange", C);
		else {
	...
	for (s = 0; s < l; s++) if (o = r[s], d = o.parentNode === D, "BR" !== o.nodeName) if (G && (A = o.style, $ || d || (o._x += o.parentNode._x, o._y += o.parentNode._y), A.left = o._x + "px", A.top = o._y + "px", A.position = "absolute", A.display = "block", A.width = o._w + 1 + "px", A.height = o._h + "px"), !$ && q) if (o._isSplit) for (o._next = E = o.nextSibling, o.parentNode.appendChild(o); E && 3 === E.nodeType && " " === E.textContent;) o._next = E.nextSibling, o.parentNode.appendChild(E), E = E.nextSibling;
...
//#endregion
export { m as SplitText, m as default };
